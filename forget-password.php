...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
        ...
        $message = '<p>To reset your password, please click on the link below.<br> <a href="'.BASE_URL.'reset-password.php?email='.$_POST['cust_email'].'&token='.$token.'">Click here</a>';
        
        $to      = $_POST['cust_email'];
        $subject = 'PASSWORD RESET REQUEST - YOUR TrendHub.COM';
        $headers = "From: its.rehan119@gmail.com" . "\r\n" .
